...
from hrm.models import Employee, EmployeeBenefitAccount, EmployeeBankAccount, BankDatabase
# set up Django
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options): 
        try:
            ...
            #delete any existing data in hrm models in order of dependencies
            EmployeeBankAccount.objects.all().delete()
            EmployeeBenefitAccount.objects.all().delete()
            Employee.objects.all().delete()
            BankDatabase.objects.all().delete()
            ...
            self.stdout.write(self.style.SUCCESS("Data has been loaded."))
